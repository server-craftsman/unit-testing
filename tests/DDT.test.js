// // Import the necessary utilities from the testing framework
// import { describe, it, expect  } from "vitest";

// // stringUtils.test.js
// import { describe, it, expect } from 'vitest';
// import { capitalizeWords } from '../src/stringUlti';

// const capitalizeWordsTestData = [
...
// const capitalizeWordsInvalidTestData = [
...
//   // Test valid inputs
//   it.each(capitalizeWordsTestData)(
//     'should capitalize words in "%s" as "%s"',
//     (input, expected) => {
...
//   // Test invalid inputs
//   it.each(capitalizeWordsInvalidTestData)(
//     'should throw an error for invalid input %s',
//     (input, errorMessage) => {
//       expect(() => capitalizeWords(input)).toThrow(errorMessage);
//     }
//   );
// });
